...
<head>
    ...
    <title>Cadastro Professor - EnemBemLegal</title>
...
<body>
    <main class="register-container">
        <div class="register-header">
            ...
            <p>Comece a compartilhar seu conhecimento</p>
        </div>
        ...
        <form action="cadastra ai professor.php" method="POST" class="register-form">
        ...
        <div class="login-link">
            Já tem uma conta?
            <a href="entrar professor.php">Entrar</a>
        </div>
    </main>
