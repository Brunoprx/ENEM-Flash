...
if (isset($_POST['nomealuno']) && isset($_POST['senhaaluno'])) {

    if (strlen($_POST['nomealuno']) == 0) {
        echo "Preencha seu e-mail";
    } else if (strlen($_POST['senhaaluno']) == 0) {
        echo "Preencha sua senha";
    } else {
        $nome = $_POST['nomealuno'];
        $senha = $_POST['senhaaluno'];

        $stmt = $conn->prepare("SELECT idaluno, nomealuno FROM Aluno WHERE nomealuno = ? AND senhaaluno = ?");
...
<head>
    ...
    <title>Login Aluno - EnemBemLegal</title>
...
<body>
    <main class="login-container">
        <div class="login-header">
            ...
            <p>Entre com sua conta de aluno</p>
        </div>
        ...
        <div class="register-link">
            ...
            <a href="cadastra ai aluno.php">Cadastre-se</a>
        </div>
    </main>
</body>
</html>
